...
def main():
    ...
    intersect.add_argument('--vertebrate', action="store_true", help="Indicate data is from non-human vertebrate. Requires a corresponding species name using the --species flag.")
    intersect.add_argument('--plant', action="store_true", help="Indicate data is from non-human, plant species. Requires a corresponding species name using the --species flag.")
    intersect.add_argument('--metazoa', action="store_true", help="Indicate data is from non-human, metazoic species. Requires a corresponding species name using the --species flag.")
    intersect.add_argument('--fungi', action="store_true", help="Indicate data is from non-human, fungal species. Requires a corresponding species name using the --species flag.")
    # intersect.add_argument('--bacteria', action="store_true", help="Indicate data is from non-human, bacterial species. Requires a corresponding species name using the --species flag.")
    ...
    sigtest.add_argument('--out', '-o', type=str, help="Output filepath. Defaults to \"hare\" if none provided.", required=False, default=None)
